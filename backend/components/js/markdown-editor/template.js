...
(function () {
    ...
    function initializeDOMElements() {
        ...
        for (const [name, element] of Object.entries(requiredElements)) {
            if (!element) {
                throw new Error(`必要�?DOM 元素未找�? ${name}`);
            }
        }
    }
        ...
        style.textContent = `
            ...
            * {
            ...
            .inline-copy-button {
                ...
                min-width: 20px !important;  /* 添加最小宽�?*/
                ...
                color: #666 !important;
                z-index: 2 !important;
                pointer-events: auto !important;  /* 确保按钮可点�?*/
            }
        ...
        container.innerHTML = `
                    ...
                    <div class="editor-container">
                        <div class="editor-header">
                            ...
                            <div class="editor-toolbar">
                                ...
                                <button class="toolbar-btn" id="codeBlockBtn" title="代码�?>
                        ...
                        <div class="editor-section">
                            <textarea id="markdown-input" placeholder="在这里输�?Markdown 文本..." readonly></textarea>
                        </div>
            ...
            <div class="code-dialog" id="codeDialog" style="display: none;">
                <div class="code-dialog-content">
                    ...
                    <textarea id="codeInput" placeholder="在这里输入代�?.."></textarea>
    ...
    function handleExportClick() {
        ...
        const title = titleInput.value || '未命名笔�?;
    ...
    function bindEventListeners() {
        ...
        if (!notepad || !openButton || !closeButton || !markdownInput || !preview ||
            !saveButton || !titleInput || !editButton || !deleteButton ||
            !importButton || !exportButton || !newNoteButton || !fileList) {
            throw new Error('必要�?DOM 元素未找到，无法绑定事件');
        }
    ...
    function initializeLoginElements() {
        ...
        if (!loginDialog || !loginBtn || !loginButton || !cancelLogin ||
            ...
            console.warn('登录相关元素未找到，跳过登录功能初始�?);
            return;
        }
    ...
    function renderNoteList(notes) {
        ...
        notes.forEach(note => {
            ...
            fileItem.innerHTML = `
                ...
                <div class="file-info">
                    <div class="file-title">${note.title || '未命名笔�?}</div>
    ...
    async function deleteCurrentNote() {
        ...
        try {
            ...
            if (index !== -1) {
                ...
                try {
                    await noteStorage.saveNotes(noteStorage.notes);
                    console.log('笔记已从服务器删�?);
                } catch (error) {
                    console.error('服务器删除失�?', error);
                    // 继续执行本地删除
                }
        ...
        document.querySelectorAll('#preview pre code').forEach(code => {
            ...
            copyButton.addEventListener('click', async () => {
                try {
                    ...
                    copyButton.innerHTML = '<span class="mdi mdi-check"></span>已复�?;
                    setTimeout(() => {
                        copyButton.innerHTML = '<span class="mdi mdi-content-copy"></span>复制';
                    }, 2000);
                } catch (err) {
